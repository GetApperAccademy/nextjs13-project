...
export default async function handler(
  req: PatchProductByProductIdApi.Request,
  res: NextApiResponse<PatchProductByProductIdApi.EndpointResponse>,
) {
  try {
    ...
    return ResponseHandler.json<PatchProductByProductIdApi.SuccessResponse>(
      res,
